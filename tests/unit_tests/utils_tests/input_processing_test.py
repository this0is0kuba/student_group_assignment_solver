...
class TestProcessingBase:
    ...
    @pytest.mark.parametrize(
        "function, expected",
        [
            (prepare_for_subjects_1, inputSubjects1Basic),
            (prepare_for_subjects_2, inputSubjects2Basic),
            (prepare_for_subjects_with_average, inputSubjectsWithAverageBasic),
            (prepare_for_groups, inputGroupsBasic)
        ]
    )
...
class TestProcessingReal:
    ...
    @pytest.mark.parametrize(
        "function, expected",
        [
            (prepare_for_subjects_1, inputSubjects1Real),
            (prepare_for_subjects_2, inputSubjects2Real),
            (prepare_for_subjects_with_average, inputSubjectsWithAverageReal),
            (prepare_for_groups, inputGroupsReal)
        ]
    )
    def test_processing(self, function, expected):
...
class TestProcessingFriends:
    ...
    @pytest.mark.parametrize(
        "function, expected",
        [
            (prepare_for_subjects_1, inputSubjects1Friends),
            (prepare_for_subjects_2, inputSubjects2Friends),
            (prepare_for_subjects_with_average, inputSubjectsWithAverageFriends),
            (prepare_for_groups, inputGroupsFriends),
            (prepare_for_groups_with_friends, inputGroupsWithFriendsFriends),
        ]
    )
    def test_processing(self, function, expected):
...
class TestProcessingCustomConstraints:
    ...
    @pytest.mark.parametrize(
        "function, expected",
        [
            (prepare_for_subjects_1, inputSubjects1CustomConstraints),
            (prepare_for_subjects_2, inputSubjects2CustomConstraints),
            (prepare_for_subjects_with_average, inputSubjectsWithAverageCustomConstraints),
            (prepare_for_groups, inputGroupsCustomConstraints)
        ]
    )
    def test_processing(self, function, expected):
