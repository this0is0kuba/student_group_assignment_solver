...
def test_prepare_predetermined_students(predetermined_subjects_for_students, expected):
...
def test_prepare_predetermined_subjects_for_students(predetermined_subjects_for_students, number_of_subjects, expected):
...
def test_prepare_student_average(list_average, expected):
...
def test_prepare_list_preferences(list_preferences, section_number, subject_section, expected):
